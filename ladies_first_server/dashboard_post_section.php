...
$request_offer= strip_tags($_POST['offer_post']);
...
$(document).ready(function(){
 ...
 var postData ="<?php echo $request_offer; ?>";
        postRow = postRow + 5;
        ...
        if(postRow <= postCount){
            ...
            $.ajax({
                url: 'https://qbtut.com/ladies_first_server/post_loadmoreData_section.php',
                type: 'post',
...
22
 ...
 "where": "{'.$offering1_type_field.'.CT.'.$request_offer.'}",
...
if($total_count == 0){
echo "<div style='background:red;color:white;padding:10px;'>No Post  has been Created on this Category Section</div>";
}
