...
var datasend = {'id': id, 'rid': rid};
		$.ajax({
			...
			type:'POST',
			url:'https://qbtut.com/ladies_first_server/notify_delete_post.php',
			data:datasend,
                        crossDomain: true,
			cache:false,
...
<p>
<a href='https://hackathon20-fesedo.quickbase.com/db/bqyb6cxvm?a=dbpage&pageID=20&title=<?php echo $title1; ?>&notifyId=<?php echo $id; ?>&rID=<?php echo $rid; ?>&pid=<?php echo $post_id; ?>' class='pull-left col-sm-5 post-css' title='View Posts'>View Posts</a>
