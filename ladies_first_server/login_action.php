...
$user_rank = $json["data"][0]["11"]["value"];
$token1 = $json["data"][0]["16"]["value"];
$usern = $json["data"][0]["17"]["value"];
$points = $json["data"][0]["14"]["value"];
$levels = $json["data"][0]["15"]["value"];
$created_time = $json["data"][0]["12"]["value"];
...
localStorage.setItem('pointssessdata', '$points');
localStorage.setItem('levelssessdata', '$levels');
localStorage.setItem('userranksessdata', '$user_rank');


localStorage.setItem('titleheader', 'Ladies First');
localStorage.setItem('titlefooter', 'Building Communities for Ladies');
...
echo "<div class='alert alert-success'>Login sucessful <i class='fa fa-spinner fa-spin' style='font-size:24px'></i></div>";
echo "<script>window.location='https://hackathon20-fesedo.quickbase.com/db/bqyb6cxvm?a=dbpage&pageID=11'</script>";
