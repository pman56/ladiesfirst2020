...
<field fid='18' filename='$fname'>$img_encode</field>
</qdbapi>
";
...
.Redirecting in a second to Login Section... <i class='fa fa-spinner fa-spin' style='font-size:24px'></i> <br></div>";

echo "<script>
window.setTimeout(function() {
    window.location.href = 'https://hackathon20-fesedo.quickbase.com/db/bqyb6cxvm?a=dbpage&pageID=7';
}, 1000);
</script><br><br>";
