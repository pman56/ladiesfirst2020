...
$(document).ready(function(){
 ...
 var postData ="<?php echo $request_offer; ?>";
        ...
        if(postRow <= postCount){
            ...
            $.ajax({
                url: 'https://qbtut.com/ladies_first_server/post_loadmoreData_category.php',
                type: 'post',
...
22
 ...
 "where": "{'.$category_type_field.'.CT.'.$request_offer.'}",
...
if($total_count == 0){
echo "<div style='background:red;color:white;padding:10px;'>No Post  has been Created Yet on this Category</div>";
}
