...
$request_userid= intval($_POST['r_id1']);
...
$(document).ready(function(){
 ...
 var postData ="<?php echo $request_userid; ?>";
        postRow = postRow + 5;
        ...
        if(postRow <= postCount){
            ...
            $.ajax({
                url: 'https://qbtut.com/ladies_first_server/post_loadmoreData_profile.php',
                type: 'post',
...
22
 ...
 "where": "{'.$userid_type_field.'.CT.'.$request_userid.'}",
